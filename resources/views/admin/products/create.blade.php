...
<div class="container mb-5 py-4">
    ...
    <form action="{{route('products.store')}}" method="post" class="card p-3" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-3">
            ...
            <small id=" titleHlper" class="text-muted">Add product title here</small>
        </div>
        ...
        <div class="mb-3">
            ...
            <small id=" descriptionHlper" class="text-muted">Add product description here</small>
        </div>

        <div class="mb-3">
            <label for="price" class="form-label">Price</label>
            <input type="number" name="price" id="price" class="form-control @error('price') is-invalid @enderror" aria-describedby="priceHlper" value="{{ old('price') }}"></input>
            <small id=" priceHlper" class="text-muted">Add product price here</small>
        </div>
